...
import { User, Mail, Lock, AlertCircle, EyeOff, Eye } from 'lucide-react';
  ...
  async function handleGoogleSignIn() {
    try {
      ...
      if (error.code === 'auth/popup-closed-by-user') {
        ...
        setError('Popup was blocked by the browser. Please enable popups or try again.');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 flex flex-col md:flex-row">
      ...
      <div className="md:hidden w-full bg-white p-4 shadow-md flex flex-col items-center">
        ...
        <h2 className="text-xl font-bold text-gray-800">Take Control of Your Finances</h2>
        <p className="text-sm text-center text-gray-600 mt-1 px-4">
          Track your expenses, income, debts, and more in one place. Get insights into your spending habits and take control of your financial future.
        </p>
      </div>
      ...
      <div className="hidden md:flex md:w-1/2 bg-white flex-col items-center justify-center p-10 shadow-2xl z-10">
        ...
        <h2 className="mt-6 text-3xl font-bold text-gray-800 text-center">Take Control of Your Finances</h2>
              ...
              >
                <svg className="h-5 w-5 mr-2" viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                  <g transform="matrix(1, 0, 0, 1, 27.009001, -39.238998)">
                    ...
                    <path
                      fill="#34A853"
                      d="M -14.754 63.239 C -11.514 63.239 -8.804 62.159 -6.824 60.329 L -10.684 57.329 C -11.764 58.049 -13.134 58.489 -14.754 58.489 C -17.884 58.489 -20.534 56.379 -21.484 53.529 L -25.464 53.529 L -25.467 56.619 C -23.494 60.539 -19.444 63.239 -14.754 63.239 Z"
                    />
                    <path
                      fill="#FBBC05"
